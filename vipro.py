...
vipro = LINETCR.LINE()
#vipro.login(qr=True)
vipro.login(token='EyM9FUGnUjCgzBD9g1h3.Pt9vsXYFErULrUPoXesFaW.bG0u1iOg2JkP1Q+/Atx9ulMqGS0ee3aSIOTlLxu95Uw=')
vipro.loginResult()
...
wait = {
    ...
    "inviteprotect":False,    
    "alwaysRead":False,    
    "Sider":{"ولا شفتك👀 تعال تعال لهوون😒 شديييتك من لون جكيتك😆 شارك😉 خليني احبك 😍"},
    "Simi":{},    
    "lang":"JP",
    "BlGroup":{}
}
